...
const AddElement = ({ title, onAdd }) => {
  return (
    <div onClick={onAdd}  className="cursor-pointer bg-surface-light hover:bg-primary/5 dark:bg-surface-dark border border-border-light dark:border-border-dark rounded-xl px-5 py-.25 flex flex-col items-center justify-center text-center">
