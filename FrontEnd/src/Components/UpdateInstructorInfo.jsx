...
//             ​
//           </span>
//           <div className="relative inline-block align-bottom bg-white dark:bg-slate-800 rounded-2xl text-left  shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full border border-slate-200 dark:border-slate-700">
...
//               </div> */}
//             </div>
//             <div className="bg-slate-50 dark:bg-slate-700/30 px-4 py-4 sm:px-6 flex flex-col sm:flex-row sm:justify-end border-t border-slate-100 dark:border-slate-700 gap-3 ">
