...
const AddFirstElement =({ title, onAdd }) => {
  return (
    <div className="bg-surface-light hover:bg-primary/5 dark:bg-surface-dark border border-border-light dark:border-border-dark rounded-xl px-5 py-6 flex flex-col items-center justify-center text-center cursor-pointer transition-colors"
     onClick={onAdd}
    >
