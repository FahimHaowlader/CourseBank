      ...
      <main className="flex-1 w-full mx-auto px-4 sm:px-6 lg:px-8 pb-8 md:pb-10 pt-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  gap-6">
          ...
          <Link
            ...
            to="moderators"
          >
            <div className="h-12 w-12 rounded-lg bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-4 group-hover:bg-blue-500 group-hover:text-white transition-colors">
              <span className="material-symbols-outlined text-[28px]">
                <MdOutlinePeopleAlt />
              </span>
            </div>
            ...
            <div className="flex items-center text-blue-600 dark:text-blue-400 font-semibold text-sm mt-auto hover:underline">
              <span>Access Module</span>
              <span className="material-symbols-outlined text-[18px] ml-1 transition-transform group-hover:translate-x-1">
                <IoArrowForwardSharp />
              </span>
          ...
          >
                        ...
                        <div className="h-12 w-12 rounded-lg bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 flex items-center justify-center mb-4 group-hover:bg-amber-500 group-hover:text-white transition-colors">
            ...
            <p className="text-sm text-text-secondary dark:text-gray-400 mb-6 flex-1">
              ...
              <div className="flex items-center text-amber-600 dark:text-amber-400 font-semibold text-sm mt-auto hover:underline">
              <span>Access Module</span>
              <span className="material-symbols-outlined text-[18px] ml-1 transition-transform group-hover:translate-x-1">
                <IoArrowForwardSharp />
              </span>
         ...
         <Link
          ...
          <Link
            ...
            href="#"
          >
            <div className="h-12 w-12 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 flex items-center justify-center mb-4 group-hover:bg-slate-600 group-hover:text-white transition-colors">
              <span className="material-symbols-outlined text-[28px]">
                <IoSettingsOutline />
              </span>
            </div>
            ...
            <div className="flex items-center text-slate-600 dark:text-slate-400 font-semibold text-sm mt-auto hover:underline">
              <span>Access Module</span>
              <span className="material-symbols-outlined text-[18px] ml-1 transition-transform group-hover:translate-x-1">
                <IoArrowForwardSharp />
              </span>
